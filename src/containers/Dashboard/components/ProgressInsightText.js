...
function ProgressInsightText(props) {
  const { fixedExpenses } = props;

  return (
    <Paper className="mt-5">
      <Row>
        <H3Bold className="font-weight-bold">Overall Status</H3Bold>
      </Row>
      <Row>
        <Table bordered>
          <THead>
...
ProgressInsightText.propTypes = {
  fixedExpenses: PropTypes.arrayOf(PropTypes.number).isRequired,
};

export default ProgressInsightText;
